import photo from '../assets/photo-sout.jpg';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="flex justify-center">
            <div className="w-80 h-80 rounded-2xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-cyan-500/30 flex items-center justify-center overflow-hidden">
          ...
          <div className="space-y-6">
            <p className="text-gray-300 text-lg leading-relaxed">
              I'm <span className="text-cyan-400 font-semibold">Mohamed Alem</span>, a passionate and curious computer science student in my 1st year Master's program in Computer Science at USTHB (Algeria).
            </p>
            <p className="text-gray-300 text-lg leading-relaxed">
              I enjoy building real-world applications that solve real problems and make a tangible impact.
            </p>
            <p className="text-gray-300 text-lg leading-relaxed">
              Front-end developer, always looking to learn, grow, and contribute to open source or collaborative projects.
            </p>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a
                href="mailto:alemmohamed238@gmail.com"
                className="w-12 h-12 rounded-lg bg-gray-800 hover:bg-cyan-600 transition-colors flex items-center justify-center"
              >
